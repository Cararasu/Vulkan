...
$(IntermediateDirectory)/Instance.cpp$(ObjectSuffix): Instance.cpp $(IntermediateDirectory)/Instance.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "E:/GNUProg/Vulkan/Instance.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Instance.cpp$(ObjectSuffix) $(IncludePath)
