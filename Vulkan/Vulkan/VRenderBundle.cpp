...
VRenderBundle::VRenderBundle ( InstanceGroup* arg_igroup, ContextGroup* arg_cgroup, Array<const RenderStage*>& arg_rstages, Array<ImageUsage>& arg_image_types, Array<ImageDependency>& arg_dependencies ) :
