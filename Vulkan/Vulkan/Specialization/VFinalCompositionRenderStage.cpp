...
VFinalCompositionRenderStage::VFinalCompositionRenderStage ( VInstance* instance, InstanceGroup* igroup ) :
...
void VFinalCompositionRenderStage::v_dispatch ( vk::CommandBuffer buffer, u32 index ) {
	...
	for ( int i = 0; i < renderpasses.size; i++ ) {
		...
		render_pipeline ( v_instance, v_igroup, v_contextgroup, &composition_pipeline, &subpass_inputs[0], buffer, i );
